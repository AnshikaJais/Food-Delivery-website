            ...
            <Container>
                <Row>
                    ...
                    <Col lg='3' md="4" sm="6">
                        ...
                        <ListGroup className="delivery__time-list">
                            <ListGroupItem className="delivery__time-item border-0 ps-0">
                                <p>Location: Gomti Nagar, Lucknow, India</p>
                ...
                <Row className={"mt-5"}>
                    <Col lg="6" md="6">
                        <p className="copyright">Copyright - 2023, website made by Anshika Jaiswal. All rights reserved.</p>
                    </Col>
                    <Col lg={"6"} md={"6"}>
